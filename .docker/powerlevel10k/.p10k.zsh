# Generated by Powerlevel10k configuration wizard on 2022-02-26 at 13:04 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 16080.
# Wizard options: powerline, lean_8colors, unicode, 2 lines, disconnected, no frame,
...
() {
  ...
  # only when the current configuration, account or project _id changes.
